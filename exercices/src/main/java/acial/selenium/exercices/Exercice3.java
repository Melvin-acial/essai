...
public class Exercice3 {
	...
	public Object[][] dataProviderMethod() {
		return new Object[][] { { "Zinedine", "Zidane", "3601" }, { "Trésor", "Marius", "3602" } };
	}
	
	  @DataProvider(name = "Identifiant")
	    public Object[][] getIds() {
	        return new Object[][] { { "3601" }, { "3602" } };
	        }
	...
	public void testAjouterEmploy(String nom , String prenom , String ID) throws Exception {
		...
		driver.findElement(
				By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Next'])[1]/following::select[1]"))
				.click();
		driver.findElement(
				By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Next'])[1]/following::select[2]"))
				.click();
		driver.findElement(By.linkText("14")).click();
		driver.findElement(By.id("btnSave")).click();
	}

	@Test(dataProvider = "Identifiant" , priority = 3)
	public void testSupprimerEmploy(String identifiant) throws Exception {
		driver.findElement(By.xpath(
				"(.//*[normalize-space(text()) and normalize-space(.)='Social Media Authentication'])[1]/following::b[1]"))
				.click();
